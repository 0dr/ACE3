...
if (isClient && !isHeadless) then
{
    ...
    ["MOCAP", "Legs kick", "Legs kick", {if (isNil 'MOCAP_disabled_fighting') then {"leg" call MOCAP_RscDisplayMission_fnc_EH_keyDown};}, {}, [DIK_T, [true, false, false]]] call cba_fnc_addKeybind;
    ["MOCAP", "Takedowns/Grabs", "Takedowns/Grabs", {if (isNil 'MOCAP_disabled_grabs') then {"grab" call MOCAP_RscDisplayMission_fnc_EH_keyDown};}, {}, [DIK_T, [false, true, false]]] call cba_fnc_addKeybind;
    }
    else
    {
